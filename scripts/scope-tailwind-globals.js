...
// `important: '.aw-payments-scope'` doesn't touch:
...
const FILE = 'dist/anubis-payments.js'
const original = readFileSync(FILE, 'utf8')

const replacements = [
    {
        pattern: /\*,:before,:after\{/g,
        replacement: '.aw-payments-scope,.aw-payments-scope :before,.aw-payments-scope :after{',
        label: '*, :before, :after',
    },
    {
        pattern: /::backdrop\{/g,
        replacement: '.aw-payments-scope ::backdrop{',
        label: '::backdrop',
    },
]
